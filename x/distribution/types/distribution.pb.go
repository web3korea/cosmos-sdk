...
type Ratio struct {
	...
	Base           cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=base,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"base"`
	Burn           cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=burn,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"burn"`
}
...
func (m *BurnFee) Reset()         { *m = BurnFee{} }
func (m *BurnFee) String() string { return proto.CompactTextString(m) }
func (*BurnFee) ProtoMessage()    {}
func (*BurnFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd78a31ea281a992, []int{15}
}
func (m *BurnFee) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BurnFee) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BurnFee.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BurnFee) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BurnFee.Merge(m, src)
}
func (m *BurnFee) XXX_Size() int {
	return m.Size()
}
func (m *BurnFee) XXX_DiscardUnknown() {
	xxx_messageInfo_BurnFee.DiscardUnknown(m)
}

var xxx_messageInfo_BurnFee proto.InternalMessageInfo

func (m *BurnFee) GetTotalBurned() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Moderator)(nil), "cosmos.distribution.v1beta1.Moderator")
	proto.RegisterType((*Base)(nil), "cosmos.distribution.v1beta1.Base")
	proto.RegisterType((*BurnFee)(nil), "cosmos.distribution.v1beta1.BurnFee")
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
...
func (this *Moderator) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Moderator)
	if !ok {
		that2, ok := that.(Moderator)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Base) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
...
func (this *BurnFee) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*BurnFee)
	if !ok {
		that2, ok := that.(BurnFee)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *BurnFee) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BurnFee) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BurnFee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BurnFee) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BurnFee: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BurnFee: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
