...
import (
	...
	simulateappparams "github.com/cosmos/cosmos-sdk/simulateapp/params"
...
func AppStateFnWithExtendedCbs(
	...
	return func(r *rand.Rand, accs []simtypes.Account, config simtypes.Config,
		...
		case config.GenesisFile != "":
			// override the default chain-id from simulateapp to set it later to the config
...
func AppStateRandomizedFnWithState(
	...
	appParams.GetOrGenerate(
		cdc, simulateappparams.StakePerAccount, &initialStake, r,
		func(r *rand.Rand) { initialStake = sdkmath.NewInt(r.Int63n(1e12)) },
	)
	appParams.GetOrGenerate(
		cdc, simulateappparams.InitiallyBondedValidators, &numInitiallyBonded, r,
