...
func Test_TestnetCmd(t *testing.T) {
	...
	err = genutiltest.ExecInitCmd(simulateapp.ModuleBasics, home, encodingConfig.Codec)
	require.NoError(t, err)
	...
	cmd := testnetInitFilesCmd(simulateapp.ModuleBasics, banktypes.GenesisBalancesIterator{})
