...
+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.13/x/bank/types/tx.pb.go#L288-L294
...
+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.13/x/bank/keeper/msg_server.go#L14-L16

`msgServer` methods can retrieve the `sdk.Context` from the `context.Context` parameter method using the `sdk.UnwrapSDKContext`:

+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.13/x/bank/keeper/msg_server.go#L27-L27
...
+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.13/baseapp/msg_service_router.go#L127
...
+++ https://github.com/cosmos/cosmos-sdk/blob/v0.46.13/x/auth/vesting/msg_server.go#L73-L85
