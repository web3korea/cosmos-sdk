...
1. Chain Upgrade Guide to v0.46:
   ...
   * See [Release Notes](https://github.com/cosmos/cosmos-sdk/blob/v0.46.13/RELEASE_NOTES.md) and [changelog](https://github.com/cosmos/cosmos-sdk/blob/v0.46.13/CHANGELOG.md) for the exhaustive list of API and State Machine breaking changes.
